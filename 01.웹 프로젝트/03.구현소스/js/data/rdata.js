...
const roomsData = {
    "luxury":["ROOM", "LUXURY", 
    "유려한 곡선과 금속 몰딩의 인테리어로 우아함과 모던한 분위기를 연출하는 럭셔리 룸은 17층부터 31층까지 위치하여 도심 속에서 잊지 못할 최상의 안락함과 품격있는 서비스를 선보입니다. 그레이와 블루계열의 부드러운 조화로 절제된 우아함을 담은 프렌치 시크 분위기와 객실 내에 비치되어 있는 프렌치 바스 어메니티 딥티크, 음성 인식 AI 시스템 기가지니 서비스로 프렌치 라이프 스타일의 최상의 휴식을 제안합니다.",
    "3명", "더블 또는 트윈", "37㎡", "침실 1, 화장실 1", "시티뷰", "15:00 / 12:00"],
    "magnifique":["ROOM", "MAGNIFIQUE", 
    "기존의 프렌치 스타일인 우아한 곡선과 프렌치 모던의 정제함을 소피텔만의 스타일로 재해석하여 아늑하고 차분한 분위기로 파리지앵의 감성을 연상시키며 실용적인 공간을 제공합니다. 편안한 숙면을 취하고 휴식을 도와줄 Sofitel MyBed로 하루의 피로를 풀고 원기를 충전하며, 소피텔 앰배서더 서울에서 즐기는 도심 속 모던 프렌치 럭셔리를 경험해 보십시오.",
    "3명", "더블", "44㎡", "침실 1, 화장실 1", "시티뷰", "15:00 / 12:00"],
    "luxurylake":["ROOM", "LUXURY LAKE", 
    "아름다운 석촌 호수 전망이 조망되는 객실에서 여유로운 아침을 맞이할 수 있는 럭셔리 레이크 룸은 블루 앤 화이트 쉐브론 패턴의 카펫과 모던 프렌치의 정제된 디테일로 파리지앵 별장처럼 매력적인 느낌을 주며 프렌치 시크 감성과 소피텔만의 편안함을 모두에게 선사합니다. 프렌치 바스 어메니티 딥티크와 음성 인식 AI 시스템 기가지니 서비스로 최상의 휴식을 경험해 보십시오.",
    "3명", "더블 또는 트윈", "37㎡", "침실 1, 화장실 1", "호수뷰", "15:00 / 12:00"],
    "clubluxury":["ROOM", "CLUB LUXURY", 
    "25층부터 31층에 위치한 클럽 럭셔리 룸은 곡선이 주는 부드러움과 모던한 분위기를 연출하여 최상의 안락함과 품격있는 서비스를 제공하며 다양한 혜택을 즐길 수 있는 클럽 밀레짐 고객만의 특권이 주어집니다. 프렌치 바스 어메니티 딥티크를 갖춘 매력적인 독립형 욕실에서의 색다른 휴식 시간으로 소피텔 앰배서더 서울만의 모던 프렌치 럭셔리 라이프를 경험해 보십시오.",
    "3명", "더블", "37㎡", "침실 1, 화장실 1", "호수뷰", "15:00 / 12:00"],
    "magnifiquefamily":["ROOM", "MAGNIFIQUE FAMILY", 
    "차분한 분위기를 자아내는 크림, 그레이, 블루 컬러와 금속 몰딩의 조화로 모던함을 연출하는 매니피크 패밀리룸은 매력적인 도시의 전경과 한층 더 여유로운 공간을 자랑합니다. 더블 베드와 싱글 베드가 준비돼 있어 가족이 함께 즐기기에 제격인 객실 타입입니다. 객실 내 비치되어 있는 프렌치 바스 어메니티 딥티크와 하루의 피로를 풀어줄 Sofitel My Bed로 나만의 휴식 시간을 제안합니다.",
    "4명", "더블 및 싱글", "57㎡", "침실 1, 화장실 1", "시티뷰", "15:00 / 12:00"],
}

export {rdata, rsdata, fdata, roomsData}